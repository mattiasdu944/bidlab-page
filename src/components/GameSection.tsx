        ...
        <section id="games">
            <div className='lg:flex flex-col justify-center items-center min-h-screen container mx-auto'>
                <Fade direction="down" delay={400} duration={1200}>
                    <h2 className="text-4xl text-center mb-2 font-bold text-gradient">Nuestro ultimo lanzamiento</h2>
                    <p className="mb-8 text-center">Conoce nuestro ultimo juego aun en desarrollo que hara volar tu imaginacion</p>
                </Fade>

                <Fade direction="up" delay={400} duration={1500}>
                    <div className="max-w-md mx-auto bg-gradient-to-t from-blue-500 to-indigo-500 p-1 rounded-md hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/50 transition-all">
